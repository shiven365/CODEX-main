    ...
    <nav className="nav-container">
      <div className="nav-content">
        ...
        <div className="auth-buttons">
          <button onClick={onLoginClick} className="button-54">
            Login
          </button>
          <button onClick={onSignupClick} className="button-54">
            SignUp
          </button>
        </div>
      ...
      {isOpen && (
        <ul className="mobile-menu">
          <li>
            <Link to="/" className="mobile-nav-link">Profile</Link>
          </li>
          <li>
            <button onClick={onLoginClick} className="button-54 mobile-button">
              Login
            </button>
          </li>
          <li>
            <button onClick={onSignupClick} className="button-54 mobile-button">
              SignUp
            </button>
          </li>
        </ul>
